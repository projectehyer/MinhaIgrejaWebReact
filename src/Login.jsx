...
export default function Login() {
  ...
  // Configuração para habilitar/desabilitar login social
  const ENABLE_SOCIAL_LOGIN = process.env.REACT_APP_ENABLE_SOCIAL_LOGIN === 'true';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Login Social - Só aparece se habilitado */}
        {ENABLE_SOCIAL_LOGIN && (
          <>
            ...
            {/* Separador - Só aparece se login social estiver habilitado */}
            <div style={{
              display: 'flex',
              alignItems: 'center',
              marginBottom: '24px'
